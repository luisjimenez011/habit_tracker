...
router.delete('/me', auth, async (req, res) => {
    ...
    try {
        ...
        await client.query("DELETE FROM challenges WHERE creator_id = $1", [user_id]);
        await client.query("DELETE FROM user_challenges WHERE user_id = $1", [user_id]);
...
// 7. Obtener el perfil de cualquier usuario a partir de su ID. (Ruta dinámica)
// GET /api/users/:id
